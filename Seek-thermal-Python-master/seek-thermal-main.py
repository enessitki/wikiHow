...
# serverAddressPort = ("192.168.2.53", 6000)  # statik olan ipye ayarladım
#
# bufferSize = 800000  # 2'nin üssü olacak şekilde ayarlanmalı
#
# # Protokol              #Udp bağlantı stream olsaydı tcp bağlantı tipi olacaktı
# UDPClientSocket = socket.socket(family=socket.AF_INET, type=socket.SOCK_DGRAM)

clientsocket = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
clientsocket.connect(('192.168.2.53', 9001))
...
class SeekPro():
  ...
  """
    ...
    """
        ...
        ret = self.dev.read(0x81, 13680, 10000)
...
if __name__ == '__main__':
    ...
    while True:
        ...
        r = cam.get_image()
        # print(r)
        # print(type(rescale(r)))
        # print(rescale(r))
        # print("rescale edilen frame uzunluğu değeri")
        # print(len(rescale(r)))
        # print("0. indeksteki frame değerleri")
        # print(rescale(r)[0])
        # print("0. indeksteki frame uzunluğu değeri")
        # print(len(rescale(r)[0]))
        cv2.namedWindow('Seek', cv2.WINDOW_NORMAL)
        cv2.resizeWindow('Seek', 1280, 720)
        ...
        #UDP SOCKET
        # bytesToSend = str.encode(str(rescale(r)))  # encode et
        # UDPClientSocket.sendto(bytesToSend, serverAddressPort)
        # print(bytesToSend)
        # print("Received {0} bytes of data.".format(sys.getsizeof(a)))
